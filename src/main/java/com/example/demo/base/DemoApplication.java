...
import com.example.demo.controllers.SimulationController;
import com.example.demo.models.World;
import com.example.demo.views.DefaultWebSocketView;
...
@EnableWebSocket
public class DemoApplication extends SpringBootServletInitializer implements WebSocketConfigurer {
